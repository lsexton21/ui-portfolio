...
This is an example of a typical entity, service, controller, route stack I added to our main PHP API.  I have done several of these, but this one was the most recent.  Please note, that this style of code is remaining consistant with the rest of the app.  There are a few updates I would personally make, like adding strict types, if I was revamping this app or building another.
